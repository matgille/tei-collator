...
-->
    ...
    <xsl:template
        match="tei:cb[@break = 'no'][not(ancestor::tei:w)][not(ancestor::tei:note)] | tei:lb[@break = 'no'][not(ancestor::tei:w)][not(ancestor::tei:note)] | tei:pb[@break = 'no'][not(ancestor::tei:w)][not(ancestor::tei:note)]"
        mode="troisiemePasse">
        <!--<xsl:template
